...
public class SpringBootAdminEnvApplicationContextInitializer extends PolarisEnvProcessor implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    private static final Logger LOG = LoggerFactory.getLogger(SpringBootAdminEnvApplicationContextInitializer.class);
